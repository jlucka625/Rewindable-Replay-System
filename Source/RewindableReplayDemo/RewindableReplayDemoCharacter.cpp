...
void ARewindableReplayDemoCharacter::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	...
	InputComponent->BindAxis("MoveRight", this, &ARewindableReplayDemoCharacter::MoveRight);

	// We have 2 versions of the rotation bindings to handle different kinds of devices differently
	// "turn" handles devices that provide an absolute delta, such as a mouse.
	// "turnrate" is for devices that we choose to treat as a rate of change, such as an analog joystick
	InputComponent->BindAxis("Turn", this, &APawn::AddControllerYawInput);
	InputComponent->BindAxis("TurnRate", this, &ARewindableReplayDemoCharacter::TurnAtRate);
	InputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	InputComponent->BindAxis("LookUpRate", this, &ARewindableReplayDemoCharacter::LookUpAtRate);
...
void ARewindableReplayDemoCharacter::TurnAtRate(float Rate)
{
...
void ARewindableReplayDemoCharacter::MoveForward(float Value)
{
